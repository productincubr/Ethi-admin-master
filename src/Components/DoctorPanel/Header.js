                ...
                <div className='header_container d-flex justify-content-between flex-wrap'>
                    ...
                    <div className='time_appointment_div d-flex align-items-center'>
                        <div className='time_div text-center'>
                            <p className='m-0 font-weight-bold text-black'>Next appointmnet in</p>
                            <div>
                                <img src={StopWatch} alt='StopWatch' />
                                <span className='text-black'><span className='time_span'>&nbsp;{leftTimeProp}</span></span>
                    ...
                    <div className='menu_bar_wrapper'>
                        <div className='menu_bar_container d-flex justify-content-around'>
                            ...
                            <Link to='/admin_feeds_and_post'>
                                <div className={`card text-center ${location.pathname === '/admin_feeds_and_post' ? 'active_menu' : ''}`}>
                                    <div className="card-body px-1 py-4">
                            ...
                            <Link to='/superadmin_my_staff_profile' hidden>
                                <div className={`card text-center ${location.pathname === '/superadmin_my_staff_profile' ? 'active_menu' : ''}`}>
                                    <div className="card-body px-1 py-4">
                            ...
                            <Link to='/my_patients'>
                                <div className={`card text-center ${location.pathname === '/my_patients' ? 'active_menu' : ''}`}>
                                    <div className="card-body px-1 py-4">
                            ...
                            <Link to='/admin_chats'>
                                <div className={`card text-center ${location.pathname === '/admin_chats' ? 'active_menu' : ''}`}>
                                    <div className="card-body px-1 py-4">
                            ...
                            <Link to='/admin_notifications'>
                                <div className={`card text-center ${location.pathname === '/admin_notifications' ? 'active_menu' : ''}`}>
                                    <div className="card-body px-1 py-4">
                            ...
                            <Link to='/admin_general_profile'>
                                <div className={`card text-center d-flex align-items-end ${location.pathname === '/admin_general_profile' ? 'active_menu' : ''}`}>
                                    <div className="card-body px-1 py-4">
                            ...
                            <Link to='/AdminSettings'>
                                <div className={`card text-center d-flex align-items-end ${location.pathname === '/AdminSettings' ? 'active_menu' : ''}`}>
                                    <div className="card-body px-1 py-4">
                                        {location.pathname === '/admin_general_profile' ? (
