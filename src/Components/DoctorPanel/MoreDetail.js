...
function DoctorCreateDietPlan() {
    ...
    await server_post_data(my_patients_data_single, fd)
      .then((Response) => {
        if (Response.data.error) {
          ...
          console.log("asadsa", Response.data.message);
          setPatientDocument(
  ...
  if (!subscriptiondetails || !subscriptiondetails.entry_date) {
    return <div>{/* <p>Invalid subscription details</p> */}</div>;
  }
                    ...
                    <div className="d-flex col-md-12 detailHeader">
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          {patients.package_start_date}
                        </p>
                        <p>
                          <b> Package End Date:</b>&nbsp;{" "}
                          {patients.package_end_date}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="my-3 wrapperDet">
                      <div className="pDetailWrapper col-md-5 my-3 p-5 ">
                        ...
                        <div>
                          ...
                          {/* <p>
                          <b> Plan Type:</b>&nbsp; {subscriptiondetails.payment_status}
                        </p> */}
                          {/* </div> */}
                        </div>
                      </div>
