...
export default function DoctorMyPatients() {
  ...
  const [patientswhatapp, setpatientswhatapp] = useState([]);
    ...
    await server_post_data(my_patients_full_details_doctor, fd)
      .then((Response) => {
        if (Response.data.error) {
          ...
          setpatientswhatapp(Response.data.message.data_customer_data_whatapp);
  ...
  const handleDeleteConfirmed = async () => {
    ...
    console.log(clickedAppointIndex);
  ...
  const [whatTabSearchValue, setwhatTabSearchValue] = useState("");
  ...
  const [filteredWhatappPatients, setfilteredWhatappPatients] = useState([]);
  ...
  const handleCurrentWhattappSearchInputChange = (event) => {
    const searchInput = event.target.value.toLowerCase();
    setwhatTabSearchValue(searchInput);

    if (searchInput.trim() !== "") {
      const filtered = patientswhatapp.filter((patient) => {
        return patient.customer_name.toLowerCase().includes(searchInput);
      });
      setfilteredWhatappPatients(filtered);
    } else {
      setfilteredWhatappPatients([]);
    }
  };
    ...
    <>
      ...
      <div className="my_patients_dash_container container-lg">
        <div className="my_patient_header row m-0">
          <h3 className="col-md-4 my-2 fntNanitu">My Patients</h3>
        ...
        <div className="row m-0">
          ...
          >
            <div className="my_patients_list_container">
              <div className="my_patients_list_head container">
                <div className="current_past_tabs">
                  <div
                    onClick={() => handleTabClick("whatapp_tab")}
                    className={
                      acivePatientsTab === "whatapp_tab"
                        ? "current_tab active_patient_list_tab"
                        : "current_tab"
                    }
                  >
                    <h6 className="fntNanitu">WhatsApp</h6>
                  </div>
                  <div
                  ...
                  >
                    <h6 className="fntNanitu">Current Patients</h6>
                  </div>
                  <div
                  ...
                  >
                    <h6 className="fntNanitu">Past Patients</h6>
                  </div>
                </div>
                <div className="my_patients_search_bar my-1 my-md-0">
                  ...
                  {acivePatientsTab === "whatapp_tab" && (
                    <input
                      ...
                      type="text"
                      placeholder="Search..."
                      value={whatTabSearchValue}
                      onChange={handleCurrentWhattappSearchInputChange}
                    />
                  )}
                  {/* For Current tab */}
                  {acivePatientsTab === "current_tab" && (
            ...
            <div className="my_patients_list_wrapper container" id="style-1">
              <h3 className="fntNanitu">Patients List</h3>
              <div className="my_patientslist_items">
                {acivePatientsTab === "whatapp_tab" ? (
                  <ul>
                    {whatTabSearchValue.trim() !== "" ? (
                      filteredWhatappPatients.map((item, index) => {
                        return (
                          <>
                            <li key={index}>
                              <>
                                <li key={index}>
                                  <div className="my_patients_item">
                                    <Link to={`/PatientProfile/${item._id}`}>
                      ...
                      <>
                        {patientswhatapp.map((item, index) => {
                          return (
                            <>
                              <li key={index}>
                                <>
              ...
              <div className="modal-body">
                <form id="createNewPatient">
                  ...
                  <div className="form-group">
                    ...
                    <select id="subscription" name="last_subscription_id">
